...
!(function (e, t) {
    ...
    var ce,
        ...
        ye = {
            ...
            isFormData: function (e) {
                var t;
                return e && (("function" == typeof FormData && e instanceof FormData) || (q(e.append) && ("formdata" === (t = L(e)) || ("object" === t && q(e.toString) && "[object FormData]" === e.toString()))));
            },
    ...
    var Pe = (function () {
        ...
        Ne = { isBrowser: !0, classes: { URLSearchParams: "undefined" != typeof URLSearchParams ? URLSearchParams : ke, FormData: "undefined" != typeof FormData ? FormData : null, Blob: "undefined" != typeof Blob ? Blob : null }, protocols: ["http", "https", "file", "blob", "url", "data"] },
    ...
    var ct,
        ...
        lt = function (e) {
            var t,
                ...
                s = n.headers,
                c = n.auth;
            if (((n.headers = s = Ge.from(s)), (n.url = Ae(at(n.baseURL, n.url, n.allowAbsoluteUrls), e.params, e.paramsSerializer)), c && s.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), ye.isFormData(o)))
                                ...
                                for (;;)
                                    switch ((e.prev = e.next)) {
                                        ...
                                        case 11:
                                            ...
                                            (S = new Request(n, { method: "POST", body: i, duplex: "half" })), ye.isFormData(i) && (x = S.headers.get("content-type")) && d.setContentType(x), S.body && ((R = rt(O, tt(nt(p)))), (k = b(R, 2)), (T = k[0]), (j = k[1]), (i = mt(S.body, 65536, T, j)));
                                        case 15:
                                            return ye.isString(y) || (y = y ? "include" : "omit"), (A = "credentials" in Request.prototype), (w = new Request(n, u(u({}, m), {}, { signal: g, method: o.toUpperCase(), headers: d.normalize().toJSON(), body: i, duplex: "half", credentials: A ? y : void 0 }))), (e.next = 20), fetch(w, m);
                                        case 20:
                                            return (
                                                (P = e.sent),
    ...
    function _t(e) {
        return (
            ...
            Lt(e.adapter || Me.adapter)(e).then(
                ...
                function (t) {
                    return $e(t) || (Nt(e), t && t.response && ((t.response.data = Xe.call(e, e.transformResponse, t.response)), (t.response.headers = Ge.from(t.response.headers)))), Promise.reject(t);
                }
            )
        );
    }
